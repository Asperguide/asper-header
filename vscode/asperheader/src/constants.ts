...
export const userHeaderLogoVersion: boolean = false;
...
/** @brief The dummy variable containing the description to use instead of having to ask the user the question every time */
...
export const preferSingleLineComments: boolean = false;
